...
const testimonialsData: Testimonial[] = [
  {
    quote: "English Route Study Abroad made my dream of studying in Canada a reality. Their team was incredibly supportive throughout the entire visa process. I couldn't have done it without them!",
    name: 'Priya Sharma',
  ...
  {
    quote: "Finding a tech job in Germany seemed impossible until I contacted English Route Study Abroad. Their interview coaching and resume services were top-notch and landed me a fantastic role in Berlin.",
    name: 'Michael Chen',
  ...
  {
    quote: "The entire process was smooth. English Route Study Abroad helped me secure admission and a scholarship for my MBA in the UK. Truly grateful!",
    name: 'David Smith',
  ...
  {
    quote: "I was overwhelmed with the US university application process. English Route Study Abroad's counselors were patient and knowledgeable. Now I'm at my dream school!",
  ...
  {
    quote: "Moving to Canada for work was a big step. English Route Study Abroad's job assistance program was a game-changer. They connected me with employers and helped with my work permit.",
    name: "Liam O'Connell",
